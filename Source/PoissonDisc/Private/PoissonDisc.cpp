...
void UPoissonDisc::Distribute2D(TArray<FVector2D>& Samples, int32 Seed, FVector2D Size, float MinimumDistance, int32 MaxStepSamples, bool WrapX, bool WrapY) {
...
void UPoissonDisc::Distribute3D(TArray<FVector>& Samples, int32 Seed /* = 0 */, FVector Size /* = FVector2D(1.0f , 1.0f) */, float MinimumDistance /* = 1.0f */, int32 MaxStepSamples /* = 30 */, bool WrapX /* = false */, bool WrapY /* = false */, bool WrapZ /* = false */) {
